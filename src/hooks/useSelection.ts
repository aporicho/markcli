...
import { stripAnsi, normalizePos } from "../utils/ranges.js";

interface UseSelectionOptions {
  lines: string[];
  viewportHeight: number;
  scrollOffset: number;
  onConfirm: (startLine: number, endLine: number, startCol: number, endCol: number) => void;
}
...
export function useSelection({ lines, viewportHeight, scrollOffset, onConfirm }: UseSelectionOptions) {
